...
class PlayerSkillPage extends StatefulWidget {
  ...
  const PlayerSkillPage({Key key, this.player}) : super(key: key);
...
class _PlayerSkillPageState extends State<PlayerSkillPage> {
  ...
  static List<PlayerAction> skills =[
    ...
    PlayerAction('matterMorph', 'MATTER MORPH', 'You affect the environment around you, changing it\'s physical properties. It requires concentration.',[Option('BRIGHTNESS','You control the brightness of the environment around you, making it bright or dark.','You make a large area bright or dark.','You make a medium area bright or dark.', 'You fail and something bad happens.'), Option('HARDNESS','You control the hardness of things around you, making them hard or soft.','You make things in a medium area around you hard or soft.', 'You make things in a small area around you hard or soft.','You fail and something bad happens.'), Option('FRICTION','You control the friction of everything around you, making them very sticky or slippery.','You make things in a medium area around you slippery or sticky.', 'You make things in a small area around you slippery or sticky.', 'You fail and something bad happens.')],0,true),
    PlayerAction('illusion', 'ILLUSION', 'You create an illusion that tricks people\'s senses. Making them see, hear, smell, taste or feel things that are not there. It requires concentration.',[Option('ILLUSION','You create smells, tastes, sounds, images, or pretty much anything that affect people\'s senses.', 'You create a powerful illusion that affects everyone in a large area around you. Tricking their senses.', 'You create an illusion that affects everyone in a medium area around you. Tricking one of their senses.', 'You fail to create the illusion and something bad happens.'),],0,true),
    PlayerAction('alchemy', 'ALCHEMY', 'You throw a mixture that splashes on contact and causes different effects.',[Option('SMOKE','It creates a cloud of thick smoke around the impact area.','It creates a large cloud of thick smoke.', 'It creates a medium cloud of thick smoke.', 'You miss and something bad happens.'), Option('ICE','It splashes around the impact point and freezes anything that it touches.','It splashes on impact and freezes everything in a medium area.', 'It splashes on impact, freezing a small area.', 'You miss and something bad happens.'), Option('FIRE','It explodes on impact and sets fire to anything that it touches.','It explodes and sets fire to a medium area.', 'It explodes and sets fire to a small area.', 'You miss and something bad happens.')],0,false),
    PlayerAction('callOfNature', 'CALL OF NATURE', 'You call for help and nature comes to your aid. It follows your command, but may ask for something in return.',[Option('ATTACK','You mark a target and nature strikes it.','Nature strikes them on a weak spot. Roll the damage.', 'Nature strikes them. Roll the damage.', 'Nature misses the target and something bad happens.'), Option('DEFEND','You mark a target and nature defends it.','Nature defends the target in time. Roll the defense.','Nature blocks part of the damage. Roll the defense.','Nature fails to defend the target and it takes full damage.'), Option('SCOUT','You ask nature for some information about a specific area.','You receive meaningful information.','You get information, but nature asks for something in return.', 'You receive bad news.'),],0,false),
    PlayerAction('faceshifter', 'FACESHIFTER', 'You transform into a person of your choice, taking their voice and appearance.',[Option('TRANSFORM','The transformation varies in strength depending on your luck. An incomplete transformation gives you the appearance, but not the voice.','The transformation is a success. You look and sound exactly like the person of your choice.','The transformation is incomplete. You look like the person of your choice, but your voice remains the same.', 'The transformation fails and something bad happens.')],0,false),
    PlayerAction('alterSenses', 'ALTER SENSES', 'You can bless or curse anyone you touch. Enhancing or taking away their senses. It requires concentration.',[Option('ENHANCE','You enhance someone, allowing them to perform incredible feats. \nLike seeing through walls, hearing whispers from far away or tracking a scent.','You bless a person you touch, enhancing two of their senses.','You bless a person you touch, enhancing one of their senses.', 'You fail and something bad happens.'), Option('REMOVE','You curse someone and remove some of their senses. Making them blind, deaf, or numb. ','You curse a person you touch, removing two of their senses.','You curse a person you touch, removing one of their senses.','You fail and something bad happens.')],0,true),
    PlayerAction('skill', 'SKILL', 'This is your signature move and what you are known for. Choose your skill by clicking on the icons above.',[Option('OPTIONS','Some skills have more than one option or effect to choose from.','','','')],0,false),
  ...
  void skillSelection(index){
    ...
    widget.player.playerAction[5] = skills[index];

    displaySkill = widget.player.playerAction[5];
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Text(displaySkill.option[index].name,
                          style: TextStyle(
                            fontFamily: 'Headline',
                            height: 1.3,
                            fontSize: 30.0,
                ...
                Padding(
                  ...
                  child: Text(displaySkill.option[index].description,
                    style: TextStyle(
                      height: 1.25,
                      fontSize: 22,
                      fontFamily: 'Calibri',
  ...
  Route _createRouteAttribute() {  //ROUTE TO ATTRIBUTE PAGE
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => PlayerAttributePage(player: widget.player,),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(displaySkill.description,
                        ...
                        Container(
                          height: MediaQuery.of(context).size.height * 0.0+displaySkill.option.length*56,
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Center(
                                            child: Text(displaySkill.option[index].name,
                                              style: TextStyle(
                                                height: 1.5,
                                                fontSize: 17,
