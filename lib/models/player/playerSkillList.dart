...
class PlayerSkillList {
  List<PlayerAction> skills = [
    ...
    PlayerAction(
        'alchemy',
        'ALCHEMY',
        'You throw a mixture that splashes on impact and causes different effects in a small area.',
        [
          Option(
              'FIRE',
              'It explodes on impact and damages everything in a small area.',
              'It deals',
              '',
              'You fail and something bad happens.',
              'DAMAGE',
          ...
          Option(
              'SMOKE',
              'It creates a cloud of thick smoke that blocks vision of an area.',
              'The cloud expands and covers a medium area.',
              'It splashes on impact and creates a cloud of thick smoke.',
              'You fail and something bad happens.',
              '',
              0),
          Option(
              'ICE',
              'It splashes on impact and freezes anything that it touches.',
              'You hit the mark and freeze anything near by.',
              'You miss the mark and it lands near by, freezing anything it touches.',
              'You fail and something bad happens.',
              '',
              0),
          Option(
              'POISON',
              'It creates a toxic cloud that lasts for a couple of turns.',
              'The cloud expands and covers a medium area.',
              'It splashes on impact and creates a cloud of toxic fumes.',
              'You fail and something bad happens.',
              '',
              0),
        ],
