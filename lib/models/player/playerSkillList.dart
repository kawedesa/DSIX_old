...
class PlayerSkillList {
  List<PlayerAction> skills = [
    PlayerAction(
      'metamorphosis',
      'METAMORPHOSIS',
      'You transform into a animal.',
      [
        Option(
            'TRANSFORM',
            'Your body changes and you get new abilities.',
            'Your transformation is perfect. You gain two abilities',
            'You transform, but you gain only one ability ',
    ...
    PlayerAction(
      ...
      [
        Option(
            'ILLUSION',
            'You make everyone around you see, hear, smell, taste or feel anything you want.',
            'You affect everyone in a large area around you.',
            'You affect everyone in a medium area around you.',
            'You fail and something bad happens.',
            '',
            0),
      ],
    ...
    PlayerAction(
      ...
      [
        Option('ATTACK', 'You use the elements to strike a target.', 'You deal',
            '', 'You fail and something bad happens.', 'DAMAGE', 0),
        Option(
            'PROTECT',
        ...
        Option(
            'ENVIRONMENT',
            'You use the elements to modify the environment around you.',
            'You change the terrain in small area around you.',
            'You change the terrain that is directly above or underneath you.',
            'You fail and something bad happens.',
            '',
            0),
      ],
    ...
    PlayerAction(
      ...
      [
        Option(
            ...
            'You can enhance two people you touch.',
            'You can enchance only one person.',
            'You fail and something bad happens.',
            '',
            0),
        Option(
