...
class Shop {
  ...
  List<Item> lightWeapons = [
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A club with a handle on the side.',
      0,
      1,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A knife with a very sharp edge.',
      1,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'Some blades that fit over your fists.',
      1,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A club with a metal blade at the end.',
      2,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A weapon with a small blade and a handle.',
      1,
      1,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A small staff with a pointy edge.',
      2,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A very light sword used for pocking.',
      2,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A short sword, but with a longer blade and better reach.',
      2,
      2,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A curved blade with a very sharp edge.',
      3,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A club with a heavy metal ball full of spikes at the end.',
      5,
      0,
      0,
      0,
    ...
    Item(
      ...
      'lightWeapon',
      '1hand',
      'A sword with a very long blade.',
      3,
      2,
      0,
      0,
  ...
  List<Item> heavyWeapons = [
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A long staff with a pointy edge.',
      3,
      0,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A staff made out of wood or metal.',
      1,
      3,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A staff with a blade on each end.',
      5,
      0,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A staff with three points at the end.',
      4,
      0,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'An heavier axe with a blade on both sides.',
      7,
      0,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A long spear with an axe at the end.',
      6,
      0,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A staff with a heavy object at the end.',
      8,
      0,
      0,
      0,
    ...
    Item(
      ...
      'heavyWeapon',
      '2hand',
      'A very long and very heavy sword.',
      5,
      2,
      0,
      0,
  ...
  List<Item> magicWeapons = [
    Item(
      ...
      'magicWeapon',
      '1hand',
      'A cristal ball with magic powers.',
      0,
      0,
      1,
      0,
    ...
    Item(
      ...
      'magicWeapon',
      '1hand',
      'A thin stick with magic powers.',
      0,
      0,
      1,
      0,
    ...
    Item(
      ...
      'magicWeapon',
      '2hand',
      'A staff with strong magic powers.',
      0,
      0,
      5,
      0,
  ...
  List<Item> armor = [
    ...
    Item(
      ...
      'armor',
      '1hand',
      'It is a bigger and heavier shield.',
      0,
      4,
      0,
      0,
    ...
    Item(
      ...
      'armor',
      'head',
      'It protects your head and face.',
      0,
      4,
      0,
      0,
    ...
    Item(
      ...
      'armor',
      '1hand',
      'It protects you from the the elements.',
      0,
      0,
      0,
      3,
    ...
    Item(
      ...
      'armor',
      'body',
      'A heavy armor that protects the body.',
      0,
      7,
      0,
      0,
  ...
  List<Item> resources = [
    Item(
      ...
      'resource',
      'consumable',
      'Stops bleeding and heals 1-3 HP.',
      0,
      0,
      0,
      0,
    ...
    Item(
      ...
      'resource',
      'consumable',
      'It answers one of your questions about the story.',
      0,
      0,
      0,
      0,
    ...
    Item(
      ...
      'resource',
      'consumable',
      'Any ordinary tool, like a hammer, rope, etc.',
      0,
      0,
      0,
      0,
    ...
    Item(
      ...
      'ammo',
      'consumable',
      'Anything you can use as ammunition.',
      0,
      0,
      0,
      0,
    ...
    Item(
      ...
      'resource',
      'consumable',
      'Anything you can eat. Heals 1-6 HP',
      0,
      0,
      0,
      0,
    ...
    Item(
      ...
      'resource',
      'consumable',
      'It gives you +3 magic armor for three turns.',
      0,
      0,
      0,
      0,
    ...
    Item(
      ...
      'resource',
      'consumable',
      'Stops bleeding and heals 2-12 HP.',
      0,
      0,
      0,
      0,
